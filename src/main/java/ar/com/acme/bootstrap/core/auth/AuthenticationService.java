...
import ar.com.acme.bootstrap.core.auth.types.IAuthenticationType;
import ar.com.acme.bootstrap.core.exception.AuthException;
import ar.com.acme.bootstrap.core.http.HttpRequestAuthorizationHeader;
import ar.com.acme.bootstrap.core.token.*;
