...
/**
 * Esta clase debe ser utilizada como un punto focal para todos los manejos de textos dentro del framework},
...
public abstract class Constantes {
     ...
     ******************************************************************************************/
    public static final String SYS_APP_INIT = "----> Iniciando Sistema...";
    public static final String SYS_APP_NOMBRE = "sys.app.nombre";
    public static final String SYS_APP_TITULO = "sys.app.titulo";
    public static final String SYS_APP_VERSION = "sys.app.version";
    public static final String SYS_APP_DB = "sys.app.database";
    public static final String SYS_APP_PATH = "sys.app.path";
    public static final String SYS_APP_NIVEL = "sys.app.nivel";
    public static final String SYS_APP_IMGPATH = "sys.app.imagepath";
    public static final String SYS_APP_IOPATH = "sys.app.iopath";
    public static final String SYS_APP_UIPPAL = "sys.app.uippal";
    public static final String SYS_APP_ICON = "sys.app.icon";
    public static final String SYS_APP_MENUICON = "sys.app.menu.icon";
    public static final String SYS_APP_WELCOME = "BIENVENIDO";
    public static final String SYS_APP_TXTERROR = "ERROR:";
    ...
    public static final String SYS_APP_END = "----> Finalizando Sistema.";
    ...
    public static final String SYS_CAD_SUCCESS = "Se ha Actualizado Satisfactoriamente...";
    public static final String SYS_CAD_FAIL = "No se ha podido Actualizar...";
    ...
    public static final String SYS_APP_CAD_FILE = "ARCHIVO";
    ...
    public static final String SYS_CAD_AUTH_URL = "/oauth";
    public static final String SYS_CAD_PASS_URL = "/password";
    ...
    public static final String MSJ_SEC_ERR_USERNOINIT = "ERROR AL VALIDAR LA SESION DEL USUARIO";
    ...
    public static final String MSJ_SEC_ERR_TOKENUSERNOOP = "EL ESTADO DEL USUARIO NO PERMITE GENERAR UN TOKEN VALIDO";
    ...
    public static final String MSJ_SEC_ERR_INVALIDTOKEN = "NO SE HA ENCONTRADO UN TOKEN DE USUARIO VALIDO";
